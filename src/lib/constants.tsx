...
export const VERCEL_REGIONS = {
  cdg1: "Paris, France (West) – cdg1",
  arn1: "Stockholm, Sweden (North) – arn1",
  dub1: "Dublin, Ireland (West) – dub1",
  lhr1: "London, United Kingdom (West) – lhr1",
  fra1: "Frankfurt, Germany (West) – fra1",
  iad1: "Washington, D.C., USA (East) – iad1",
  sfo1: "San Francisco, USA (West) – sfo1",
  pdx1: "Portland, USA (West) – pdx1",
  cle1: "Cleveland, USA (East) – cle1",
  gru1: "São Paulo, Brazil (East) – gru1",
  hkg1: "Hong Kong (East) – hkg1",
  hnd1: "Tokyo, Japan (Northeast) – hnd1",
  icn1: "Seoul, South Korea (Northeast) – icn1",
  sin1: "Singapore (Southeast) – sin1",
  bom1: "Mumbai, India (South) – bom1",
  syd1: "Sydney, Australia (Southeast) – syd1",
  kix1: "Osaka, Japan (Northeast) – kix1",
};
